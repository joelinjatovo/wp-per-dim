	...
	<form method="<?php echo esc_attr( apply_filters( 'nexway_settings_form_method_tab_' . $current_nexway_tab, 'post' ) ); ?>" id="mainform" action="" enctype="multipart/form-data">
		...
		<p class="submit">
			<?php if ( empty( $GLOBALS['hide_save_button'] ) ) : ?>
				<button name="save" class="button-primary nexway-save-button" type="submit" value="<?php esc_attr_e( 'Enregistrer', 'woocommerce' ); ?>"><?php esc_html_e( 'Save changes', 'woocommerce' ); ?></button>
			<?php endif; ?>
