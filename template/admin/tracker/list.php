...
<div class="wrap nexway-wrap">
    <h1 class="wp-heading-inline"><?php echo __( 'Liste des suivis', 'wppd' ); ?></h1>
            ...
            <table class="wp-list-table widefat fixed striped tags">
                ...
                <tbody id="the-list" data-wp-lists="list:tag">
                    <?php foreach($models as $item): ?>
                        <?php $model = \WpPerDim\Models\App\Tracker::fromWp($item); ?>
                        <tr id="tag-<?php echo $model->getPkValue(); ?>" class="level-0">
                            ...
                            <td class="name column-name has-row-actions column-primary" data-colname="Titre"><strong>
                                <a class="row-title" href="<?php echo esc_url( admin_url( 'admin.php?page=wppd-trackers&action=edit&id=' . esc_attr( $model->getPkValue() ) ) ); ?>" aria-label="Modifier «&nbsp;<?php echo $model->title; ?>&nbsp;»"><?php echo $model->title; ?></a></strong><br>
                                <div class="row-actions">
                                    <span class="edit"><a href="<?php echo esc_url( admin_url( 'admin.php?page=wppd-trackers&action=edit&id=' . esc_attr( $model->getPkValue() ) ) ); ?>" aria-label="Modifier «&nbsp;<?php echo $model->title; ?>&nbsp;»">Modifier</a> | </span>
                                    <span class="trash"><a href="<?php echo esc_url( admin_url( 'admin.php?page=wppd-trackers&action=delete&id=' . esc_attr( $model->getPkValue() ) ) ); ?>" class="submitdelete" aria-label="Supprimer «&nbsp;<?php echo $model->title; ?>&nbsp;»">Supprimer</a> | </span>
                                    <span class="view"><a href="<?php echo esc_url( admin_url( 'admin.php?page=wppd-trackers&action=show&id=' . esc_attr( $model->getPkValue() ) ) ); ?>" aria-label="Voir «&nbsp;<?php echo $model->title; ?>&nbsp;»">Afficher</a></span>
                                </div>
                            </td>
