...
<div class="wrap nexway-wrap">
    <h2><?php echo __( 'Liste des unités', 'wppd' ); ?></h2>
            ...
            <table class="wp-list-table widefat fixed striped tags">
                ...
                <tbody id="the-list" data-wp-lists="list:tag">
                    <?php foreach($models as $item): ?>
                        ...
                        <tr id="tag-<?php echo $model->getPkValue(); ?>" class="level-0">
                            ...
                            <td class="posts column-posts" data-colname="Total"><a href="edit.php?category_name=non-classe">1</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th scope="col" class="manage-column column-name column-primary sortable desc"><a href=""><span>Nom</span><span class="sorting-indicator"></span></a></th>
