...
class Script implements HooksInterface{
    ...
    public function front_script(){
        ...
        wp_enqueue_script('am4chart-animated', WPPD_URL . "/assets/plugins/am4chart/animated.js", array('am4chart'), null, true);
        wp_enqueue_script('am4chart-material', WPPD_URL . "/assets/plugins/am4chart/material.js", array('am4chart'), null, true);
    }
